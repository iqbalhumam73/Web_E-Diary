...
@section('navbar')
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="black" data-image="{{asset('template')}}/assets/img/sidebar-1.jpg">
      <!--
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="/progres-ibadah">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="/pendaftaran-akun">
              <i class="material-icons">library_books</i>
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  <a class="dropdown-item" href="/akun">Profile</a>
