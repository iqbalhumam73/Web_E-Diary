      ...
      <div class="col-md-12">
        ...
        <div class="card" style="background-color:purple"> 
          ...
          <div class="card-body""  style="color:rgb(240,240,240)" >
            <h5>Terima kasih karena sudah berkunjung di lama milik Ramadhan di Kampus (RDK) ITS!
            Nantinya, laman ini akan digunakan untuk mengunggah artikel terkait Ramadhan, laporan kegiatan RDK ITS,
            dan rangkuman kajian yang diselenggarakan oleh RDK ITS. Selamat menikmati!______ 9 Jumadil Akhir 1441 H
            2 Februari 2020
            </h5>
          </div>
        </div>
